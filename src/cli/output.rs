...
use crate::core::app::{
    ...
    AddonLockVerifyResult, AddonLockWriteResult, AddonSearchCatalogResult, BackupCatalogResult,
    BackupGroupValue, BundleAddonLockApplyResult, BundleAddonLockPlanResult, BundleApplyPlanResult,
    ...
    LocalWowAccountResult, RemovedAddonPackageResult, RestoredBackupResult,
...
fn format_optional_path_or_none(path: Option<&std::path::Path>) -> String {
...
mod tests {
    ...
    use crate::core::app::{
        ...
        AddonIndexUpdateResult, AddonInventoryResult, AddonLockApplyResult,
        AddonLockFieldChangeResult, AddonLockPackageDirectoryIssueResult, AddonLockPlanResult,
        AddonSearchCatalogResult, AddonSearchResult, AddonSourceKindResult, AddonSourceResult,
        ApplyGroupPoliciesResult, ApplyPlanSummaryResult, BackupCatalogResult, BackupEntryResult,
        BackupGroupValue, BackupMetadataResult, BundleAddonLockApplyResult,
        ...
        InstallationInspectionResult, InstallationScanResult, InstalledAddonPackageResult,
        LocalWowAccountResult, LocalWowCharacterResult, RemovedAddonPackageResult,
        ResolvedInstallationValue, ResourceApplyPolicyValue, RestoredBackupResult,
        TrackedAddonPackageResult, TrackedAddonResult, UpdatedAddonPackageResult, WowFlavorValue,
    };
    ...
    fn sample_tracked_package(package_id: &str) -> TrackedAddonPackageResult {
