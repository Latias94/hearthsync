...
pub enum AddonCommands {
    ...
    Relink {
        ...
        #[arg(
            long,
            help = "Local zip path, http(s) zip URL, github:owner/repo[@tag][#asset.zip], curseforge:modId[@fileId] (requires HEARTHSYNC_CURSEFORGE_API_KEY or CURSEFORGE_API_KEY), or wago:<project-id>[@release-id]"
        )]
        source: String,
