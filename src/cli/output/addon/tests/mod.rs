...
use super::{
    ...
    render_addon_install, render_addon_inventory, render_addon_relink, render_addon_remove,
...
use crate::core::app::{
    ...
    AddonSearchProviderFailureResult, AddonSearchResult, AdoptedAddonPackageResult,
