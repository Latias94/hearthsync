...
pub(super) struct CachedArchiveMetadata {
    pub(super) source_display_name: String,
    #[serde(default)]
    pub(super) source_ref: Option<AddonSourceRef>,
    pub(super) archive_name: String,
    pub(super) file_size: u64,
    pub(super) file_sha256: String,
    #[serde(default)]
    pub(super) fetched_at_unix_timestamp: Option<u64>,
    #[serde(default)]
...
pub(super) fn should_reuse_cached_archive(
...
pub(super) fn resolve_archive_path(
    source: &AddonSourceRef,
    archive_name: &str,
    stage_root: &Path,
    options: &AddonProviderOptions,
...
pub(super) fn download_to_path_with_headers(
...
pub(super) fn guess_archive_name_from_url(url: &str) -> Option<String> {
...
pub(super) fn cached_archive_metadata_path(archive_path: &Path) -> PathBuf {
...
pub(super) fn write_cached_archive_metadata(
    archive_path: &Path,
    source: &AddonSourceRef,
    archive_name: &str,
    remote_validators: &RemoteArchiveValidators,
...
pub(super) fn cached_archive_metadata_if_local_file_matches(
    archive_path: &Path,
    source: &AddonSourceRef,
    archive_name: &str,
...
pub(super) fn should_reuse_cached_http_archive_without_transport_validators(
    metadata: &CachedArchiveMetadata,
    options: &AddonProviderOptions,
) -> bool {
...
pub(super) fn purge_download_cache_dir(
...
pub(super) fn repair_download_cache_dir(
    http_client: &impl HttpClient,
    cache_dir: Option<&Path>,
    options: &AddonProviderOptions,
...
mod tests {
    ...
    fn repair_download_cache_removes_invalid_entries_and_orphans() {
        ...
        let valid_archive =
            write_cache_entry(temp.path(), &options, &valid_source, "valid.zip", b"ok");
