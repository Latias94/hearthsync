...
use super::{
    ...
    AddonIndexRelinkRequest, attach_addons_from_index, attach_addons_from_index_task,
    install_addon_from_index, install_addon_from_index_task, relink_addon_from_index,
    relink_addon_from_index_task, update_addons_from_index, update_addons_from_index_task,
