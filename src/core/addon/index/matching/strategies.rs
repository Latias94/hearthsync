...
use super::super::{AddonIndexPackage, AddonIndexTrackedMatchStrategy};
use super::ExplainedTrackedPackageMatch;
pub(super) fn match_by_index_package_metadata(
...
pub(super) fn match_by_exact_package_id(
    package: &AddonIndexPackage,
    tracked_packages: &[TrackedAddonPackage],
    used_package_ids: &BTreeSet<String>,
) -> AppResult<Option<ExplainedTrackedPackageMatch>> {
...
pub(super) fn match_by_curated_package_id_hints(
    package: &AddonIndexPackage,
    tracked_packages: &[TrackedAddonPackage],
    used_package_ids: &BTreeSet<String>,
) -> AppResult<Option<ExplainedTrackedPackageMatch>> {
...
pub(super) fn match_by_source_identity(
...
pub(super) fn match_by_source_family_identity(
    source: &AddonSourceRef,
    tracked_packages: &[TrackedAddonPackage],
    used_package_ids: &BTreeSet<String>,
) -> AppResult<Option<ExplainedTrackedPackageMatch>> {
...
pub(super) fn match_by_display_name(
    package: &AddonIndexPackage,
    tracked_packages: &[TrackedAddonPackage],
    used_package_ids: &BTreeSet<String>,
) -> AppResult<Option<ExplainedTrackedPackageMatch>> {
...
pub(super) fn match_by_full_addon_names(
    package: &AddonIndexPackage,
    tracked_packages: &[TrackedAddonPackage],
    used_package_ids: &BTreeSet<String>,
...
pub(super) fn expected_addon_names(
    package: &AddonIndexPackage,
...
pub(super) fn explicit_addon_names(package: &AddonIndexPackage) -> BTreeSet<String> {
...
pub(in crate::core::addon::index) fn package_id_usage_key(package_id: &str) -> String {
    package_id.trim().to_ascii_lowercase()
}

pub(super) fn package_id_is_used(used_package_ids: &BTreeSet<String>, package_id: &str) -> bool {
...
pub(super) fn tracked_package_addon_overlap(
    candidate: &TrackedAddonPackage,
    expected_addon_names: &BTreeSet<String>,
) -> usize {
    candidate
