...
- `CARGO_BUILD_JOBS=1 cargo nextest run newbeebox -j 1 --no-fail-fast` passed after adding the
  NewBeeBox WTF apply and rollback slice: 12 tests run, 12 passed, 765 skipped.
